...
class SquareEqSolverTestCase(unittest.TestCase):
    ...
    def get_remote(self):
        ...
        remote.append(ResourceObject({'name': 'filename-1_slug1', 'modified': '2020-01-30T21:59:59+00:00'}))
        remote.append(ResourceObject({'name': 'filename-2_slug2', 'modified': '2020-01-30T20:59:59+00:00'}))
        remote.append(ResourceObject({'name': 'filename-4', 'modified': '2020-01-30T20:58:59+00:00'}))
        return remote
